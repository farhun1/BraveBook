package com.hello.bravebook.ui.viewmodel

import android.app.Application
import androidx.lifecycle.AndroidViewModel
import androidx.lifecycle.viewModelScope
import com.hello.bravebook.data.local.SettingsDataStore
import com.hello.bravebook.data.local.SettingsDataStore.Companion.MATERIAL_YOU
import com.hello.bravebook.data.local.SettingsDataStore.Companion.AMOLED_BLACK
import com.hello.bravebook.data.local.SettingsDataStore.Companion.DESKTOP_LAYOUT
import com.hello.bravebook.data.local.SettingsDataStore.Companion.ENABLE_COPY_TO_CLIPBOARD
import com.hello.bravebook.data.local.SettingsDataStore.Companion.ENABLE_DOWNLOAD_CONTENT
import com.hello.bravebook.data.local.SettingsDataStore.Companion.HIDE_GROUPS
import com.hello.bravebook.data.local.SettingsDataStore.Companion.BRAVE_BLOCK_LIST
import com.hello.bravebook.data.local.SettingsDataStore.Companion.HIDE_PEOPLE_YOU_MAY_KNOW
import com.hello.bravebook.data.local.SettingsDataStore.Companion.HIDE_REELS
import com.hello.bravebook.data.local.SettingsDataStore.Companion.HIDE_STORIES
import com.hello.bravebook.data.local.SettingsDataStore.Companion.HIDE_SUGGESTED
import com.hello.bravebook.data.local.SettingsDataStore.Companion.IMMERSIVE_MODE
import com.hello.bravebook.data.local.SettingsDataStore.Companion.PINCH_TO_ZOOM
import com.hello.bravebook.data.local.SettingsDataStore.Companion.REMOVE_ADS
import com.hello.bravebook.data.local.SettingsDataStore.Companion.STICKY_NAVBAR
